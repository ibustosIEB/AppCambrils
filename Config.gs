// ════════════════════════════════════════════════════════════════
//  Config.gs — CONFIGURACIÓ MANUAL
//  Edita aquest fitxer directament a GitHub per connectar
//  l'app amb el teu Google Sheets.
// ════════════════════════════════════════════════════════════════

// PAS 1: Obre el teu Google Sheets
// PAS 2: Copia l'ID de la URL:
